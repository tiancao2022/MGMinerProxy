...
install() {
    ...
    case $choose in
    1)
    	wget https://github.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/encrypt-miner-proxy_client_linux_amd64?raw=true -O /root/encrypt_miner_proxy/encrypt-miner-proxy
        wget https://raw.githubusercontent.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/configs/client/client_sync_proxy_config.yaml -O /root/encrypt_miner_proxy/configs/client_sync_proxy_config.yaml
        wget https://raw.githubusercontent.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/configs/client/client_proxy_config.yaml -O /root/encrypt_miner_proxy/configs/client_proxy_config.yaml
    ...
    *)
    ...
    wget https://raw.githubusercontent.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/script/Linux/LinuxOneKey/Client_Run.sh -O /root/encrypt_miner_proxy/Client_Run.sh
