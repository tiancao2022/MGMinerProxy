...
install() {
    ...
    case $choose in
    1)
        wget https://github.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/encrypt-miner-proxy_linux_amd64?raw=true -O /root/encrypt_miner_proxy/encrypt-miner-proxy
        wget https://raw.githubusercontent.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/configs/server_proxy_config.yaml -O /root/encrypt_miner_proxy/configs/server_proxy_config.yaml
        wget https://raw.githubusercontent.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/configs/client_sync_proxy_config.yaml -O /root/encrypt_miner_proxy/configs/client_sync_proxy_config.yaml

        if [ -f "/root/configs_bak/server_proxy_config.yaml" ]; then
        	cp -rf /root/configs_bak/* /root/encrypt_miner_proxy/configs/
        	echo "还原原有配置成功"
    	fi
        		
	wget https://raw.githubusercontent.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/cert/cert.pem -O /root/encrypt_miner_proxy/cert/cert.pem
	wget https://raw.githubusercontent.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/cert/key.pem -O /root/encrypt_miner_proxy/cert/key.pem
        ;;
    2)
    	wget https://github.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/encrypt-miner-proxy_linux_amd64?raw=true -O /root/encrypt_miner_proxy/encrypt-miner-proxy
        wget https://raw.githubusercontent.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/v3.0.2/configs/server_proxy_config.yaml -O /root/encrypt_miner_proxy/configs/server_proxy_config.yaml
    ...
    *)
    ...
    wget https://raw.githubusercontent.com/tiancao2022/MGMinerProxy/master/encrypt-miner-proxy/script/Linux/LinuxOneKey/Server_Run.sh -O /root/encrypt_miner_proxy/Server_Run.sh
